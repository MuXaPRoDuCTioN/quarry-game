...
func generate_tutorial_level():
	...
	# Стена 1 - известняк (ID 0), частота 150 Гц (диапазон 100-200)
	wall_tiles[Vector2i(5, 3)] = 0
	wall_frequencies[Vector2i(5, 3)] = 150
	
	# Стена 2 - кимберлит (ID 3), частота 450 Гц (диапазон 400-500)
	wall_tiles[Vector2i(9, 3)] = 3
	wall_frequencies[Vector2i(9, 3)] = 450
